...
- [BL-072] `[partial/local-mock]` Add Fortinet read-only connector scaffolding. Service and client registered via `registerConnector()` with capability `['read_firewall_context']`. Status shows 'unconfigured' / 'Not connected'. No real Fortinet instance connected.
