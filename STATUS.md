...
- **BL-083/086/087/090 accepted.** Production-readiness hardening wave: OIDC browser login flow with Keycloak realm role mapping, service account token store with SHA-256 hashing and expiry, API gateway hardening (rate limits, body limits, validation, security headers, audit events), backup/restore runbooks, and release packaging with demo reset.
