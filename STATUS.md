...
- **BL-137/138/139/140 `[accepted]` — User testing pipeline + first tester round.** Sessions 144-147, 148/149 truth repair, 150. One-command demo, 10/10 smoke, tester onboarding pack (7 docs), bug context capture, UI polish, 6+4 browser screenshots. First tester packet, round plan, internal dry run, operator checklist, GLPI seed fix, "Sandbox mode" label. Ready for real testers.
