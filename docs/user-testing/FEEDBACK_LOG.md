...
| ID | Date | Tester | Persona | Round | Clarity | Usefulness | Trust | Speed | Polish | Observed Hesitation | Tester Quote | Bug Context Captured | Evidence Folder | Top Issue | Severity | Tags | Resolution | BL-XXX | Status |
|----|------|--------|---------|-------|---------|------------|-------|-------|--------|---------------------|--------------|----------------------|-----------------|-----------|----------|------|------------|--------|--------|
| — | — | — | — | — | — | — | — | — | — | — | — | — | — | — | — | — | — | — | — |
...
| FB-004 | 2026-05-04 | internal-preflight | Helpdesk | 1 | 3 | 3 | 3 | 4 | 3 | — | — | — | — | "Zammad mode" header label misleading | P2 | trust-gap, frontend | FIXED — Changed to "Sandbox mode" in session 150 | — | Resolved |
| FB-005 | 2026-05-04 | internal-preflight | Helpdesk | 1 | — | — | — | — | — | — | — | — | — | No session search/filter | P2 | frontend | FIXED — Session search + quick filters added in BL-141 session 152 | BL-141 | Resolved |
| FB-006 | 2026-05-04 | internal-preflight | Helpdesk | 1 | — | — | — | — | — | — | — | — | — | No "Start here" guided walkthrough | P2 | frontend, docs | FIXED — DemoGuidePanel added in BL-141 session 152 | BL-141 | Resolved |
