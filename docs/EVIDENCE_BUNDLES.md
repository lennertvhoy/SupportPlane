...
| Generated by | Actor/user ID from mock dev headers |
...
- **No real database persistence:** The API still uses an in-memory store. Bundles are lost on restart.
...
|----------|--------|--------|---------------|
| `/support-sessions/:id/evidence-bundle` | GET | JSON envelope | `x-tenant-id`, `x-user-id` |
| `/support-sessions/:id/evidence-bundle.json` | GET | JSON envelope | `x-tenant-id`, `x-user-id` |
| `/support-sessions/:id/evidence-bundle.md` | GET | `text/markdown` | `x-tenant-id`, `x-user-id` |
